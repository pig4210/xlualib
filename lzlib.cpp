...
static int LUA_C_zlib_compress(lua_State* ls)
  ...
  while(true)
    ...
    lua_pushstring(ls, (xmsg() << "zlibÑ¹ËõÊ§°Ü : " << rets).c_str());
    return lua_error(ls);
    }
  }
...
static int LUA_C_zlib_uncompress(lua_State* ls)
  ...
  while(true)
    ...
    lua_pushstring(ls, (xmsg() << "zlib½âÑ¹Ê§°Ü : " << rets).c_str());
    return lua_error(ls);
    }
  }
...
static int LUA_C_gzip_compress(lua_State* ls)
  ...
  while(true)
    ...
    if(rets != Z_OK)
      {
      lua_pushstring(ls, (xmsg() << "gzipÑ¹Ëõ³õÊ¼»¯Ê§°Ü : " << rets).c_str());
      return lua_error(ls);
      }
    ...
    lua_pushstring(ls, (xmsg() << "Ñ¹ËõÊ§°Ü : " << rets << ' ' << rend).c_str());
    return lua_error(ls);
    }
  }
...
static int LUA_C_gzip_uncompress(lua_State* ls)
  ...
  while(true)
    ...
    if(rets != Z_OK)
      {
      lua_pushstring(ls, (xmsg() << "gzip½âÑ¹Ëõ³õÊ¼»¯Ê§°Ü : " << rets).c_str());
      return lua_error(ls);
      }
    ...
    lua_pushstring(ls, (xmsg() << "½âÑ¹ËõÊ§°Ü : " << rets).c_str());
    return lua_error(ls);
    }
  }
